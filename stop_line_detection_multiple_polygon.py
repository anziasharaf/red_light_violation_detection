...
#points=get_points()
#print("cordinates in main",points)
cord_1=[(489,244),(606,201),(1073,418),(904,512)]
polygon1 = Polygon(cord_1)
print(cord_1)
cord_2=[(904,512),(489,246),(391,281),(769,601)]
polygon2=Polygon(cord_2)
cord_3=[(769,601),(604,705),(313,324),(393,281)]

print(cord_2)
#cord_3=[(931,528),(656,705),(329,333),(422,295)]
polygon3=Polygon(cord_3)
#print(cord_3)
...
while True:
    ...
    for i in indices:
        if classes_ids[i] in interested_class_ids:
            ...
            pt=Point(c_x,c_y)
            check_point=pt.within(polygon1) or pt.within(polygon2) or pt.within(polygon3)
            print(check_point)
            if check_point==True:
                conf = confidences[i]
