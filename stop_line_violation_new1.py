...
def stop_line_detection():
    video_path='/home/user/Desktop/projects/stop_line_detection/Red_light_violation_videos/video_3.mp4'
    ...
    while True:
        ...
        for i in indices:
            if classes_ids[i] in interested_class_ids:
                ...
                print(value)
                print(x_cord2)
                if x1>x_cord1 and x1<x_cord2 :
                    if y1>y_cord1-150 and y1<y_cord2:
                        if value<0:
                            conf = confidences[i]
