...
def getFirstFrame(videofile):
    ...
    if success:
        cv2.imwrite("./preview/reference_frame_106.png", image)
        image_name="./preview/reference_frame_106.png"
        return image_name
class DrawLineWidget(object):
    def __init__(self):
        self.original_image = cv2.imread('./preview/reference_frame_106.png')
